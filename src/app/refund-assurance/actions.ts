...
export async function sendRefundAssuranceEmail(
  tenantEmail: string,
  pdfBase64: string,
  fileName: string
  ...
  try {
    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          <h2 style="color: #0f1f3d; font-size: 20px; font-weight: 700; margin-bottom: 8px;">Official Refund Assurance Document</h2>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">Dear Mr. Dharani Addanki,</p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Congratulations on your approval for 5001 Hickory Park Dr! Please find attached your official Refund Assurance Agreement, confirming that all fees paid are fully refundable under the terms outlined in the document.
          </p>
    ...
    const response = await resend.emails.send({
      ...
      to: tenantEmail,
      subject: "Refund Assurance Agreement — 5001 Hickory Park Dr",
      html,
    ...
    console.error("Error sending refund assurance email:", error);
