    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">Dear Todd M. Houser,</p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">
            ...
            <strong>836 Rhodora Ave, Reading, PA 19605</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            A total balance of <strong style="color: #0f1f3d;">$800.00</strong> is outstanding for the first month's rent.
            Full payment is required for the final process of ratification and to meet at the home at 1pm.
          </p>
