      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        <div style="background: #0f1f3d; padding: 28px 32px; display: flex; align-items: center; gap: 16px;">
          ...
          <div>
            ...
            <div style="color: #b8c4d4; font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase;">Administración de Propiedades Licenciada</div>
          </div>
        </div>
        <div style="background: linear-gradient(90deg, #b8943a 0%, #d4ad52 50%, #b8943a 100%); height: 4px;"></div>
        <div style="background: #fff; padding: 32px;">
          <h2 style="color: #0f1f3d; font-size: 20px; font-weight: 700; margin-bottom: 8px;">Certificado de Registro</h2>
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Adjunto encontrará su Certificado de Registro Oficial para la propiedad en <strong>179 Eisley Rd, Milton, PA 17847</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            Este documento confirma que la propiedad ha sido registrada exitosamente y oficialmente asignada a usted por el Consejo del Condado de Northumberland — División de Vivienda y Propiedades.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6;">
            Si tiene alguna pregunta, por favor contáctese con el administrador de propiedades asignado en Core Key Realty.
          </p>
        </div>
