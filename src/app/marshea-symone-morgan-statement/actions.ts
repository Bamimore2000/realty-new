...
export async function sendStatementEmail(
  ...
  try {
      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Please find attached your official Statement of Account confirming your registration for 501 Hampton Ave, North Augusta, SC 29841, and outlining the remaining balance required for key handover.
          </p>
    ...
    const response = await resend.emails.send({
      ...
      to: tenantEmail,
      subject: "Statement of Account — 501 Hampton Ave",
      html,
