...
export default function AmyRashellJaimeStatementPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      if (!result) return;
      result.pdf.save("amy-rashell-jaime-statement.pdf");
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const res = await sendStatementEmail(
        email,
        result.base64,
        "amy-rashell-jaime-statement.pdf",
      );
      if (res.success) {
        ...
        <div style={{ padding: "36px 48px" }}>
          ...
          >
            ...
            <div>
              ...
              <p style={{ ...valueStyle, marginTop: 4 }}>Amy Rashell Jaime</p>
            ...
            >
              ...
              <div>
                ...
                <span style={{ fontSize: 11, color: "#388e3c" }}>
                  Three adult application fees totaling $210.00 have been
                  received and fully cleared.
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            Amy Rashell Jaime (hereinafter "Lessee") to confirm the successful
            ...
            payments. Per South Carolina landlord-tenant law, the Lessee is now
            ...
            <table style={tableStyle}>
              ...
              <tbody>
                <tr>
                  ...
                  >
                    <em>
                      Pursuant to South Carolina landlord-tenant law. Deposit
          ...
          >
            ...
            >
              ...
              #INV-2026-0901 &nbsp;·&nbsp; Issued: June 19, 2026
            </div>
          </div>
        </div>
      </div>
