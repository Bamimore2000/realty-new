    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">Dear Courtney Padden,</p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">
            ...
            <strong>1139 Sanderson Ave, Scranton, PA 18509</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            A total balance of <strong style="color: #0f1f3d;">$900.00</strong> is outstanding —
            comprising $100 from month 2 and $800 for month 3 rent required to finalize your rental agreement.
          </p>
