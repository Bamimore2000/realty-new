...
const TENANT_PHOTO = "/WhatsApp Image 2026-05-22 at 20.49.01.jpeg";
...
export default function CourtneyStatementPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      if (!result) return;
      result.pdf.save("courtney-padden-statement.pdf");
        ...
        <div style={{ padding: "36px 48px" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 24, marginTop: 10, flexWrap: "wrap" }}>
                <div>
                  ...
                  <p style={val}>1139 Sanderson Ave, Scranton, PA 18509</p>
                </div>
                <div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              ...
              <tbody>
                ...
                <tr style={{ borderBottom: "1px solid #f0ede8" }}>
                  <td style={{ padding: "12px 14px", color: "#2a2520" }}>
                    Month 2 — Rent
                    <div style={{ fontSize: 11, color: "#8a6000", marginTop: 3 }}>
                      $700 received ·{" "}
                      <strong style={{ color: "#c0392b" }}>$100 balance remaining</strong>
                    </div>
                  </td>
                  <td style={{ padding: "12px 14px" }}>
                    <span
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              ...
              <tbody>
                <tr>
                  ...
                  >
                    Unpaid portion of partial payment
                  </td>
                  <td
                    style={{
                      background: "#fff8e1",
                ...
                <tr>
                  ...
                  >
                    Required to execute rental agreement
                  </td>
                  <td
                    style={{
                      background: "#fff3cd",
          ...
          >
            ...
            >
              ...
              of <strong style={{ color: "#5a5048" }}>$900.00</strong> is outstanding —
              comprising the $100 balance from month 2 and $800 for month 3. Full payment is
              required to finalize the rental agreement and release keys at 1139 Sanderson Ave,
              Scranton, PA 18509.
              <br />
              <br />
