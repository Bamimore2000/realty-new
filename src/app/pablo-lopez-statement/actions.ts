    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          <h1 style="color: #0f1f3d; font-size: 20px; font-weight: 700; margin-bottom: 8px;">Official Notice & Statement of Account</h1>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">Dear Pablo Lopez,</p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            ...
            <strong>1004 Dartmouth St, Chattanooga, TN 37405</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            We are pleased to confirm that your application fees totaling <strong>$140.00</strong> have been 
            <strong style="color: #2e7d32;">received and fully cleared via Chime</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6;">
            If you have any questions, please don't hesitate to contact Landlord Robert Sansone or Attorney of Record Daniel Hall.
          </p>
        </div>
        <div style="background: #0f1f3d; padding: 20px 32px; text-align: center;">
          <p style="color: #b8c4d4; font-size: 12px; margin: 0;">Invitation Homes &nbsp;·&nbsp; Licensed Tennessee Property Management</p>
        </div>
      </div>
    `;
