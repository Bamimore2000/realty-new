      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Please find attached your official Certificate of Registration for the property at <strong>260 W 18th St, San Bernadino, CA 92405</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            This document confirms that the property has been successfully registered and officially allocated to you by the San Bernardino County Council — Housing & Property Division.
          </p>
