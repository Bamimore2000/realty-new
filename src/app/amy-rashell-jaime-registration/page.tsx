...
export default function AmyRashellJaimeRegistrationPage() {
  const certificateRef = useRef<HTMLDivElement>(null);
  const [isSending, setIsSending] = useState(false);
  const [email, setEmail] = useState("");

  const [tenantName, setTenantName] = useState("Amy Rashell Jaime");
  const [propertyAddress, setPropertyAddress] = useState(
    "758 Jefferson Ave, Rock Hill, SC 29730",
  );
  const [dateIssued, setDateIssued] = useState("June 19, 2026");
  const [registrationId, setRegistrationId] = useState("REG-2026-0901");
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              York County Council — Housing & Property Division
            </h2>
            <p
              style={{
                fontSize: 10,
            ...
            >
              Office of Residential Registration · Rock Hill District
            </p>
          </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                ...
                >
                  Lic. No. SC-PMO-2026-901 · York County
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p style={{ ...val, margin: 0 }}>York County, South Carolina</p>
            </div>
            <div>
          ...
          >
            <p style={{ margin: "0 0 16px 0" }}>
              ...
              <strong>York County Council — Housing & Property Division</strong>
            ...
            <p style={{ margin: "0 0 16px 0" }}>
              ...
              management firm operating within the jurisdiction of York County.
              All requisite documentation, background screening, lease
              compliance reviews, and statutory filings have been completed in
              accordance with the South Carolina Residential Tenancy Act and the
            ...
            <p style={{ margin: 0 }}>
              ...
              registered with the York County Council — Housing & Property
          ...
          >
            ...
            <span>
              ...
              document has been issued under the authority of the York County
        ...
        >
          ...
          >
            York County Council · Housing & Property Division · Rock Hill, SC
            29730
          </p>
        </div>
