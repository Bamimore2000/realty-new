...
export default function JabouriDensonRegistrationPage() {
  const certificateRef = useRef<HTMLDivElement>(null);
  const [isSending, setIsSending] = useState(false);
  const [email, setEmail] = useState("");

  const [tenantName, setTenantName] = useState("Jabouri Denson");
  ...
  const [registrationId, setRegistrationId] = useState("REG-2026-0847");
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "36px 48px 0 48px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20, paddingBottom: 16, borderBottom: "1px solid #e8e4dc" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 10, color: "#8a8070", marginTop: 2 }}>Lic. No. GA-PMO-2024-3821 · Dougherty County</div>
              </div>
            </div>
          ...
          <div style={{ background: "#f7f4ef", border: "1px solid #d4c9b0", padding: "24px 28px", marginBottom: 28, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <div>
              ...
              <p style={{ ...val, margin: 0 }}>Dougherty County, Georgia</p>
            </div>
            <div>
          ...
          <div style={{ background: "#0f1f3d", color: "#b8c4d4", fontSize: 11, padding: "12px 20px", letterSpacing: "0.06em", lineHeight: 1.6, marginBottom: 36, display: "flex", gap: 12, alignItems: "flex-start" }}>
            ...
            <span>
              <strong style={{ color: "#fff" }}>Legal Notice:</strong> This document has been issued under the authority of the Dougherty County Council and the Georgia Department of Community Affairs (DCA). Falsification or misuse of this certificate is a violation of O.C.G.A. § 16-10-20 and may result in civil or criminal penalties. This certificate is valid only for the named tenant and address above.
            </span>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 0, paddingBottom: 48 }}>
            ...
            <div style={{ textAlign: "center", minWidth: 180 }}>
              ...
              <div style={{ borderTop: "1px solid #0f1f3d", paddingTop: 8 }}>
                ...
                <p style={{ fontSize: 10, color: "#8a8070", textTransform: "uppercase", letterSpacing: "0.1em", margin: 0 }}>Landlord & Authorized Agent</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
              ...
              >
                ...
                <p style={{ fontSize: 9, color: "#0f1f3d", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", margin: "0 0 3px 0" }}>Dougherty County</p>
            ...
            <div style={{ textAlign: "center", minWidth: 180 }}>
              ...
              <div style={{ borderTop: "1px solid #0f1f3d", paddingTop: 8 }}>
                <p style={{ fontSize: 13, fontWeight: 700, color: "#0f1f3d", margin: "0 0 2px 0" }}>Robinson Allan, Esq.</p>
                <p style={{ fontSize: 10, color: "#8a8070", textTransform: "uppercase", letterSpacing: "0.1em", margin: 0 }}>Attorney of Record</p>
                <p style={{ fontSize: 10, color: "#8a8070", margin: "2px 0 0 0" }}>Bar No. GA-2014-00192</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: "#0f1f3d", padding: "16px 48px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <p style={{ color: "#6b7a94", fontSize: 10, margin: 0 }}>
            Dougherty County Council · Housing &amp; Property Division · Albany, GA 31707
          </p>
        </div>
