    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">Dear Mrs. Tanya Marie Mendy,</p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Please find attached your Statement of Account confirming all payments received and the outstanding balance required prior to key handover.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            We are pleased to confirm that your initial fees totaling <strong>$740.00</strong> have been
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px; background: #fff8e8; border-left: 4px solid #e8c94a; padding: 12px 16px; border-radius: 0 6px 6px 0;">
            <strong>Pending Balance: $900.00</strong> — This amount must be settled before the keys to the property are handed over.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6;">
            If you have any questions, please don't hesitate to reach out to Landlord Alan Scott.
          </p>
        </div>
