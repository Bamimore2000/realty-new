    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          <h1 style="color: #0f1f3d; font-size: 20px; font-weight: 700; margin-bottom: 8px;">Certificate of Registration</h1>
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Please find attached your official Certificate of Registration for the property at <strong>1004 Dartmouth St, Chattanooga, TN 37405</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            This document confirms that the property has been successfully registered and officially allocated to you by the Hamilton County Council — Housing &amp; Property Division.
          </p>
