...
export async function sendRentalDocumentEmail(
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      to: email,
      subject: "🏠 Official Statement: Invitation Homes - 2300 Hilltop Dr",
      html: `
        <div style="font-family: 'Times New Roman', serif; max-width: 600px; margin: 0 auto; color: #1f2937; line-height: 1.6;">
          <div style="text-align: center; border-bottom: 2px solid #111827; padding-bottom: 20px; margin-bottom: 30px;">
            ...
            <p style="font-size: 14px; color: #6b7280; margin: 5px 0 0 0;">2300 Hilltop Dr, Albany, GA 31707</p>
          </div>
          
          <div style="padding: 0 10px;">
            <p>Dear Mr Denson,</p>
            
            <p>Please find attached the official <strong>Statement of Account & Occupancy Intent</strong> regarding the property at 2300 Hilltop Dr.</p>
            ...
            <div style="background-color: #f9fafb; padding: 20px; border-radius: 8px; border: 1px solid #e5e7eb; margin: 25px 0;">
              ...
              <ul style="margin: 0; padding-left: 20px;">
                <li><strong>Verified Credits:</strong> $670.00 (Processed via Chime)</li>
