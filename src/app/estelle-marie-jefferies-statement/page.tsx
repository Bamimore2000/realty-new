...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function EstelleMarieJefferiesStatementPage() {
  ...
  const handleDownload = async () => {
    try {
      ...
      if (!result) return;
      result.pdf.save("estelle-marie-jefferies-statement.pdf");
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const res = await sendStatementEmail(
        email,
        result.base64,
        "estelle-marie-jefferies-statement.pdf",
      );
      if (res.success) {
        ...
        <div style={{ padding: "36px 48px" }}>
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <p style={{ ...valueStyle, marginTop: 4 }}>June 17, 2026</p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Application Fee Fully Satisfied
                </p>
                <span style={{ fontSize: 11, color: "#388e3c" }}>
                  Pursuant to Tennessee landlord-tenant law, the application fee
                  of $70.00 has been received and fully cleared.
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            Estelle Marie Jefferies (hereinafter "Lessee") to confirm the
            successful remittance of the application fee. The Lessor,{" "}
            <strong>Robert Sansone</strong>, and the Attorney of Record,{" "}
            <strong>Daniel Hall, Esq.</strong>, acknowledge receipt of the
            $70.00 application fee. Per Tennessee landlord-tenant law, the
            Lessee is now required to fulfill the payment of the security
            deposit prior to the physical handover of keys.
          </div>
          ...
          {/* New Balance Due — Security Deposit */}
          <div style={{ marginBottom: 28 }}>
            <SectionTitle>Required Remittance — Security Deposit</SectionTitle>
            <table style={tableStyle}>
              <thead>
                <tr style={{ background: "#0f1f3d" }}>
              ...
              <tbody>
                <tr>
                  ...
                  >
                    ...
                    >
                      Fully refundable if property is not accepted after
                      viewing. This recently renovated home is in excellent
                      condition.
                    </div>
                  </td>
                  <td
                  ...
                  >
                    <em>
                      Pursuant to Tennessee landlord-tenant law. Deposit is
                      fully refundable should Lessee decline the property after
                      viewing.
                    </em>
                  </td>
                  <td
          ...
          >
            ...
            <div>
              ...
              >
                Formal Notice — Key Handover & Deposit
              </div>
              <div
                style={{ fontSize: 11.5, color: "#8a6000", lineHeight: 1.75 }}
              >
                Please be advised that the payment of the{" "}
                <strong>Security Deposit ($750.00)</strong> is required prior to
                the handover of keys. A meeting will be scheduled to hand over
                the keys once the deposit is received.
                <br />
                <br />
                <strong>Important:</strong> The deposit is fully refundable
                should you decide not to take the property after viewing it.
                This is a rare opportunity as the home is great and has been
                recently renovated!
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              Invitation Homes &nbsp;·&nbsp; Licensed Georgia Property
              Management
            </div>
            <div
              style={{ color: "#6a7a90", fontSize: 9, letterSpacing: "0.08em" }}
            >
              Tennessee Landlord-Tenant Law &nbsp;·&nbsp; Ref: #INV-2026-0850
              &nbsp;·&nbsp; Issued: June 17, 2026
            </div>
          </div>
        </div>
