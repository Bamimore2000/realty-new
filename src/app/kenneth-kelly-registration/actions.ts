...
export async function sendCertificateEmail(
  ...
  try {
      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            Please find attached your official Certificate of Home Registration confirming that the property has been duly registered in your name by Invitation Homes and Landlord Joe Valdez.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 14px;">
            This document confirms the successful completion of all registration requirements and the official transfer of the property into your name.
          </p>
    ...
    const response = await resend.emails.send({
      ...
      to: tenantEmail,
      subject: "Certificate of Home Registration — Invitation Homes",
      html,
      attachments: [
        {
          filename: fileName,
