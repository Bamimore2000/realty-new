...
export default function RegistrationCertificatePage() {
  ...
  const [tenantName, setTenantName] = useState("Theresa Dismuke");
  const [propertyAddress, setPropertyAddress] = useState("2300 Hilltop Dr, Albany, GA 31707");
  const [dateIssued, setDateIssued] = useState("June 4, 2026");
  const [registrationId, setRegistrationId] = useState("REG-2026-0836");
