    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #f0ede8;">
        ...
        <div style="background: #fff; padding: 32px;">
          <h2 style="color: #0f1f3d; font-size: 20px; font-weight: 700; margin-bottom: 8px;">Registration Certificate</h2>
          ...
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 12px;">
            Please find attached your official Certificate of Registration for the property located at <strong>2300 Hilltop Dr, Albany, GA 31707</strong>.
          </p>
          <p style="color: #374151; font-size: 15px; line-height: 1.6; margin-bottom: 20px;">
            This document confirms that the property has been successfully registered and officially allocated to you by the Dougherty County Council — Housing & Property Division.
          </p>
